...
public class HomeMostLikedAdapter extends RecyclerView.Adapter<HomeMostLikedAdapter.RecyclerViewHolder> {
    ...
    public HomeMostLikedAdapter(Context mContext, ArrayList<ClinicModel> productModels) {
    ...
    public RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.fragment_clinic_most_like_item, parent, false);

...
import com.example.dental.adapters.SearchServiceAdapter;
...
public class SearchServiceActivity extends AppCompatActivity implements ClinicView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_clinic_search_service_list);
        ...
        presenter.getServicesByClinicId(SaveSharedPreference.getUserName(this), Long.parseLong(intent.getStringExtra("clinicId").trim()));
    }
...
//            tempList.add(clinic);
//        }
//        adapter = new SearchServiceAdapter(this, tempList);
//        clinicList.setAdapter(adapter);
    ...
    public void getServicesByClinicId(List<ServiceModel> listResult) {
        adapter = new SearchServiceAdapter(this,(ArrayList<ServiceModel>) listResult);
        clinicList.setAdapter(adapter);
    }

...
public class HomeNearbyFragment extends Fragment implements ClinicView {
    private RecyclerView clinicList;
    HomeNearbyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_clinic_nearby_list, container, false);
